...
def calculate_demographic_data(print_data=True):
    ...
    race_count = round(df['race'].value_counts())
    ...
    highest_earning_country = (highest_earning_country_stats/country_count*100).idxmax()
    highest_earning_country_percentage = round((highest_earning_country_stats/country_count*100).max(),1)
